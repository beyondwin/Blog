...
This thought is the first public memory seed for the context refinement article.
It anchors the memory page around routing, validation, and answer quality.
