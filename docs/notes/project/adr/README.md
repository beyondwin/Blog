...
| [ADR-0005](0005-node-react-modular-monolith.md) | Node/React 모듈러 모놀리스와 분리된 공개 projection | accepted | 2026-08-24 | Node/React runtime, 앱 경계, immutable public release와 측정 기반 public renderer 품질 게이트를 고정한다. |
