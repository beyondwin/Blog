...
| [ADR-0005](0005-node-react-modular-monolith.md) | Node/React 모듈러 모놀리스와 분리된 공개 projection | accepted | 2026-08-23 | Node/React runtime, 앱 경계, PostgreSQL·worker, immutable public release와 단순한 운영 구조를 고정한다. |
