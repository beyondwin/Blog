...
import { createProviderEmbeddingAuthorities, prepareEmbeddingSet } from '../src/modules/public-answer/infrastructure/postgres/postgres-answer-release-indexer.js';
