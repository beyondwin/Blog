...
const coverAsset = {
  ...
  redistributionEvidence: {
    ...
    decisionDocument: 'docs/notes/project/assets/review-cover-rights/black-swan/redistribution-decision.yml',
    decisionChecksum: `sha256:${'d'.repeat(64)}`,
    sourceAsset: '/assets/content/reviews/black-swan/cover.jpg',
    sourceChecksum: `sha256:${'0'.repeat(64)}`,
    width: 458,
    height: 671,
