...
const [routeCss, readingCss, collectionsCss] = import.meta.env.SSR ? await Promise.all([
...
export function loadDetail(release: CandidateRelease, slug: string | undefined) { return loadSecondaryDetail(release, 'analysis', slug); }
...
export default function AnalysisRoute({ loaderData }: { loaderData: ReturnType<typeof loadDetail> }) { return <SecondaryDetailPresentation data={loaderData} />; }
