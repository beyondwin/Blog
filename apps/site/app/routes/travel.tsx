...
export function loadDetail(release: CandidateRelease, slug: string | undefined) { return loadSecondaryDetail(release, 'travel', slug); }
...
export default function TravelRoute({ loaderData }: { loaderData: ReturnType<typeof loadDetail> }) { return <SecondaryDetailPresentation data={loaderData} />; }
