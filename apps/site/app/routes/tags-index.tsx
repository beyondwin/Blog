...
export function TagsIndexPresentation({ data }: { data: Awaited<ReturnType<typeof loader>> }) {
  return <><DocumentMetadata canonical="/tags/" description="찾기로 이어진 단어들." title={publicMetadataTitle()} /><SiteShell currentSection="search"><TagsPage tags={data.tags} /></SiteShell></>;
}
