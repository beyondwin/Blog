...
export function loader() { return loadSecondaryIndex('ideas'); }
export default function IdeasIndexRoute({ loaderData }: { loaderData: Awaited<ReturnType<typeof loader>> }) { return <SecondaryIndexPresentation collection="ideas" data={loaderData} />; }
